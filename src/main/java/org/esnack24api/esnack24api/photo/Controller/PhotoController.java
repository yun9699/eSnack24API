...
public class PhotoController {
    ...
    public ResponseEntity<Map<String, Object>> saveState(@RequestBody String result) throws JsonProcessingException {
        ...
        String fastApiUrl = "https://esnack24.store/fastapi/v1/upload";  // FastAPI 파일 업로드 URL
        String searchUrl = "https://esnack24.store/fastapi/v1/search";  // FastAPI 유사 이미지 검색 URL
